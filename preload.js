...
contextBridge.exposeInMainWorld('api', {
  ...
  folders: {
    ...
    listDirectory: (payload) => ipcRenderer.invoke('folders:listDirectory', payload),
    listFilesInDirectory: (payload) => ipcRenderer.invoke('folders:listFilesInDirectory', payload),
    moveFileFromPath: (payload) => ipcRenderer.invoke('folders:moveFileFromPath', payload),
    checkFileExists: (payload) => ipcRenderer.invoke('folders:checkFileExists', payload),
  },
